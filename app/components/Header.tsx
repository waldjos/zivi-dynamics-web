...
export function Header() {
  ...
  return <header className="site-header">
    <div className="container site-nav">
      ...
      <Link className="btn small desktop-cta" href="/contacto">Iniciar proyecto <span aria-hidden="true">↗</span></Link>
    ...
    <div className={`mobile-menu-layer ${open ? "open" : ""}`} aria-hidden={!open}>
      ...
      <nav id={menuId} className="mobile-menu" aria-label="Navegación móvil">
        <div className="mobile-menu-head"><strong>Zivi / Índice</strong><button type="button" aria-label="Cerrar menú" onClick={() => setOpen(false)}>×</button></div>
        ...
        <Link className="mobile-primary" href="/contacto">Iniciar proyecto</Link>
