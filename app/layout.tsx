...
export const metadata: Metadata = {
  ...
  icons: { icon: "/brand/zivi-mark.svg", apple: "/brand/zivi-mark.svg" },
  manifest: "/manifest.webmanifest",
};

const organization = {
  "@context":"https://schema.org", "@type":["Organization","ProfessionalService"], name:"Zivi Dynamics C.A.", legalName:"Zivi Dynamics C.A.", taxID:"J-508175123", url:"https://zivi.com", logo:"https://zivi.com/brand/zivi-logo-horizontal-full.svg", email:"ziviagency@gmail.com", telephone:"+58 412 706 5848",
